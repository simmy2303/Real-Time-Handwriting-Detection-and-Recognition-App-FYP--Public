...
h5_model_path = os.path.join(configs.model_path, "model.h5")
model.load_weights(h5_model_path)

# Callbacks
early_stopping = EarlyStopping(
    monitor="val_CER",
    mode="min",  # <---- THIS IS IMPORTANT
    patience=10,
...
meta.key = "vocab"
meta.value = configs.vocab
onnx.save(model_onnx, onnx_path)

print(f"✅ ONNX Model successfully saved at: {onnx_path} with vocab metadata")
